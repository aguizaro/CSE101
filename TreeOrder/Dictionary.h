//-----------------------------------------------------------------------------
// Dictionary.h - Antonio Guizar Orozco
// PA7
// CruzID: aguizaro
//
...
private:
   ...
   void inOrderString(std::string& s, Node* R, std::string delimiter= "") const;

   // preOrderString()
   // Appends a string representation of the tree rooted at R to s. The appended
   // string consists of keys only, separated by "\n", with the order determined
   // by a pre-order tree walk.
   void preOrderString(std::string& s, Node* R, std::string delimiter= "") const;

   // preOrderCopy()
   // Recursively inserts a deep copy of the subtree rooted at R into this 
   // Recursion ends at NIL
   void preOrderCopy(Node* R, Node* NIL);
