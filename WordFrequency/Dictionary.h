//-----------------------------------------------------------------------------
// Dictionary.h - Antonio Guizar Oroco
// PA8
// CruzID: aguizaro
//
...
private:
   ...
   void inOrderString(std::string& s, Node* R, std::string delim= "") const;
   ...
   void preOrderString(std::string& s, Node* R, std::string delim= "") const;
